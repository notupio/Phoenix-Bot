...
async function getHelpMenu({ client, guild }) {
  ...
  const embed = new EmbedBuilder()
    ...
    .setThumbnail('https://media.discordapp.net/attachments/1090643206217150546/1090643298567344198/help.gif?ex=66359cf9&is=66344b79&hm=968e63ab75a2cedbee621777b94d31cf72e456e94ed2fae1eddf49713bf0d3ec&=')
    .setDescription(
...
function getMsgCategoryEmbeds(client, category, prefix) {
  ...
  if (category === "IMAGE") {
    ...
    const embed = new EmbedBuilder()
      .setColor(EMBED_COLORS.BOT_EMBED)
      .setThumbnail(`https://images-ext-1.discordapp.net/external/mjfzYPL4JM040Mb02QrQyf9807Ym5w9LkArzFbPRcFw/https/img.icons8.com/sf-black-filled/256/DD00FF/image.png?format=webp&quality=lossless`)
      .setAuthor({ name: `${category} Commands` })
      .setDescription(collector);
